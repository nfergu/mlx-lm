...
def generate_step(
    ...
    *,
    ...
    search_strategy: Callable = linear_search
    ...
    Args:
        ...
        search_strategy (Callable): A function that returns a generator
            of tokens and log probabilities, based on the current prompt and cache.
